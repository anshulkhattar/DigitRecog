...
public class Detector {
    private static final String LOG_TAG = Detector.class.getSimpleName();
    ...
    public Detector(Activity activity) throws IOException {
    ...
    public Output classify(Bitmap bitmap) {
